...
feature "Inviting potential users:" do
  ...
  scenario "Admin can send an invitation to an email address" do
    ...
    assert(invited_user.employers.includes(partner) == true, "The invited user is not associated with the correct partner.
                                             User's partner is : #{invited_user.employers}
